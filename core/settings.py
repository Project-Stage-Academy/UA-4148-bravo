...
ELASTICSEARCH_DSL = {
    'default': {
        'hosts': config('http://elasticsearch:9200', default='http://localhost:9200'),
    },
}

# Override Elasticsearch index names for testing
if 'test' in sys.argv:
    ELASTICSEARCH_DSL['default']['hosts'] = config('http://elasticsearch:9200', default='http://localhost:9200')
