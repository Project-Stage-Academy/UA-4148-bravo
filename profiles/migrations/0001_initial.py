    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='company/logos/', validators=[validation.validate_image.validate_image_file])),
                ('description', models.TextField(blank=True, default='')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('preferred_stage', models.CharField(choices=[('idea', 'Idea'), ('prototype', 'Prototype'), ('mvp', 'MVP'), ('growth', 'Growth'), ('scale', 'Scale'), ('enterprise', 'Enterprise')], default='mvp', max_length=20)),
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='profiles.location')),
            ],
            options={
