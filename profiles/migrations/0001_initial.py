    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('stage', models.CharField(choices=[('idea', 'Idea'), ('prototype', 'Prototype'), ('mvp', 'MVP'), ('growth', 'Growth'), ('scale', 'Scale'), ('enterprise', 'Enterprise')], default='idea', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('stage', models.CharField(choices=[('idea', 'Idea'), ('prototype', 'Prototype'), ('mvp', 'MVP'), ('growth', 'Growth'), ('scale', 'Scale'), ('enterprise', 'Enterprise')], default='mvp', max_length=20)),
