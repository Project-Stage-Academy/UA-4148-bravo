...
class InvestmentShareServiceTest(TestCase):
    ...
    def test_recalculate_shares(self):
        ...
        self.assertEqual(total_share, Decimal('100.00'))
    ...
    def test_single_subscription_gets_100_percent(self):
        ...
        """
        s1 = Subscription.objects.create(project=self.project, investor=self.investor1, amount=Decimal('999.99'))
    ...
    def test_investment_share_precision(self):
        ...
        """
        s1 = Subscription.objects.create(project=self.project, investor=self.investor1, amount=Decimal('1'))
        s2 = Subscription.objects.create(project=self.project, investor=self.investor2, amount=Decimal('2'))
