    ...
    return (
        <div className={'who-we-are'}>
            <div className={'who-we-are__container'}>
                <h2 className={'who-we-are__title'}>Хто ми</h2>
                <div className={'who-we-are__content'}>
                    <div className={'who-we-are__text'}>
                        <p>
                            <span className={'who-we-are__text--bold'}>CraftMerge</span> - перший форум Західної України, який створений у співпраці з Національним університетом «Львівська політехніка». Наша місія - не лише об'єднання українських виробників та стартапів, а й відкриття нових перспектив у виробничій галузі.
                        </p>
                        <p>
                    ...
                    <div className={'who-we-are__image-container'}>
                        <Image src={'/pictures/png/pexels-pavel-danilyuk.png'} alt={'Who we are'} className={'who-we-are__image'} />
                    </div>
                </div>
            </div>
        </div>
