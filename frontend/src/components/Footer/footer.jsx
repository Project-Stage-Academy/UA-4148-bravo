        ...
        <footer className={"footer"}>
            <section className={"contacts"}>
                <div className={"contacts--logo"}>
                    <img src="./pictures/svg/footer-logo.svg" alt="Footer Logo"/>
                </div>
                ...
                <div className={"contacts--links"}>
                    <Link to={'mailto:qwerty@gmail.com'} className={"contacts--link"}>
                        <img src="./pictures/svg/mail.svg" alt="Mail"/>
                        <p>qwerty@gmail.com</p>
                    </Link>
                    <Link to={'tel:+380502342323'} className={"contacts--link"}>
            ...
            <section className={"link-tree"}>
                <div className={"branch-list"}>
                    <div className={"branch"}>
                        <h2 className={"branch-list--title"}>
                            Підприємства
                        </h2>
            ...
            <section className={"dev-contact"}>
                <div>
                    <img src="./pictures/svg/opentech-logo.svg" alt="Dev-Company Logo"/>
                </div>
